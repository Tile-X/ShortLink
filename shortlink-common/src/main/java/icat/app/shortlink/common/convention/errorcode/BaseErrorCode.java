package icat.app.shortlink.common.convention.errorcode;
...
public enum BaseErrorCode implements IErrorCode {
    ...
    USERNAME_OR_PASSWORD_ERROR("A000201", "用户名或密码错误"),
    USER_NOT_LOGIN_ERROR("A000202", "用户未登录"),
    USER_UPDATE_ERROR("A000203", "用户信息修改失败"),
